...
namespace Driver.Corsair
{
    ...
    internal static class _CUESDK
    {
        ...
        private static void LoadCUESDK()
        {
            ...
            var possibleX86NativePaths = new List<string> { HomePath + "\\CUESDK.dll", "C:\\Users\\jacklrpendleton\\source\\repos\\Driver.Corsair\\Driver.Corsair\\bin\\Debug\\CUESDK.dll" };
            var possibleX64NativePaths = new List<string> { HomePath + "\\CUESDK64.dll", "C:\\Users\\jacklrpendleton\\source\\repos\\Driver.Corsair\\Driver.Corsair\\bin\\Debug\\CUESDK64.dll" };
