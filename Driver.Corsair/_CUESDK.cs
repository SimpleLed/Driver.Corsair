...
namespace Driver.Corsair
{
    ...
    internal static class _CUESDK
    {
        ...
        private static void LoadCUESDK()
        {
            ...
            var possibleX86NativePaths = new List<string> { HomePath + "\\CUESDK.dll", "C:\\Users\\james\\source\\repos\\Org\\SimpleLed\\SimpleLedTestHarness\\bin\\Debug\\CUESDK.dll" };
            var possibleX64NativePaths = new List<string> { HomePath + "\\CUESDK64.dll", "C:\\Users\\james\\source\\repos\\Org\\SimpleLed\\SimpleLedTestHarness\\bin\\Debug\\CUESDK64.dll" };
